        ...
        <div className="relative rounded-2xl overflow-hidden">
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-5">
              <div>
                <h2 className="text-2xl font-bold text-foreground" data-testid="text-modal-name">
                  {property.name}
                </h2>
                <p className="text-base text-muted-foreground flex items-center mt-1" data-testid="text-modal-location">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <Badge className="bg-muted text-foreground px-3 py-1.5 rounded-full text-sm font-medium" data-testid="text-modal-units">
            ...
            {/* Capacity */}
            <div className="mb-5">
              <h3 className="text-lg font-bold text-foreground mb-2">Kapasitas</h3>
              <p className="text-muted-foreground flex items-center" data-testid="text-modal-capacity">
                <span className="mr-2">👥</span>
                {property.capacity}
              </p>
            </div>
            ...
            {/* Rates */}
            <div className="mb-5">
              <h3 className="text-lg font-bold text-foreground mb-2">Harga</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3" data-testid="rates-grid">
                {property.rates.map((rate, index) => (
                  <div key={index} className="bg-muted p-3 rounded-lg" data-testid={`rate-item-${index}`}>
            ...
            {/* Facilities */}
            <div className="mb-5">
              <h3 className="text-lg font-bold text-foreground mb-2">Fasilitas</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-1.5" data-testid="facilities-grid">
                {property.facilities.map((facility, index) => (
                  <div key={index} className="flex items-center" data-testid={`facility-item-${index}`}>
                    <Check className="text-primary mr-2 h-3.5 w-3.5" />
            ...
            {/* Notes */}
            <div className="mb-6">
              <h3 className="text-lg font-bold text-foreground mb-2">Syarat & Ketentuan</h3>
              <ul className="space-y-1" data-testid="notes-list">
                {property.notes.map((note, index) => (
                  <li key={index} className="flex items-start" data-testid={`note-item-${index}`}>
                    <Info className="text-primary mr-2 mt-0.5 h-3.5 w-3.5 flex-shrink-0" />
            ...
            {/* Info Message */}
            <div className="mb-5 p-3 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800/30 rounded-xl">
              <p className="text-blue-800 dark:text-blue-300 text-center font-medium text-sm">
